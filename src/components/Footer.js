    ...
    <footer className={`footer2 ${className}`}>
        ...
        <div className="join-us-parent">
          ...
          <div className="subscribe-button">
            <button className="button14">
              <div className="button15">Sign up for Free</div>
            </button>
          </div>
        </div>
      ...
      <div className="company-info-parent">
        <div className="company-info1">
          <div className="logo5">
            ...
            <div className="emiratigifts5">EmiratiGifts</div>
          </div>
        ...
        <div className="gift-card-links1">
      ...
      <div className="copyright-social1">
        ...
        <div className="social-icons2">
          <img className="paypal-icon2" alt="" src="/paypal.svg" />
          <img className="dash-dash-icon2" alt="" src="/dashdash.svg" />
          <img className="blogger-icon2" alt="" src="/blogger.svg" />
          <img className="instagram-icon2" alt="" src="/instagram.svg" />
          <img className="facebook-icon2" alt="" src="/facebook.svg" />
